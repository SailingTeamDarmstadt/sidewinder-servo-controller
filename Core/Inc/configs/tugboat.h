 ...
 *  Author: malte
 *
 * Servo configuration file for the motorized tug boat
 *
 */

#ifndef INC_CONFIGS_TUGBOAT_H_
#define INC_CONFIGS_TUGBOAT_H_
...
/* sail channel is the motor channel here */
const uint32_t CHAN2_OUT_MINVAL = 1400;
const uint32_t CHAN2_OUT_MAXVAL = 1600;
/* main sail winch address used for motor control */
